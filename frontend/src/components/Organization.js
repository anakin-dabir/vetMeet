            ...
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text" style={{ marginTop: "0.6rem" }}>
                  Type:<span style={{ color: "#0d6efd" }}>{l.type}</span>
                </p>
                <div className="text-center">
                  <Link to={`/dashboard/community`}>
                    <button
                      ...
                      onClick={() => {
                        localStorage.setItem("communityID", l._id);
                      }}
                    >
                      View Details
                    </button>
  ...
  return (
    <div className="mt-2">
      ...
      <div className="container">
        <div className="row">{!isLoading && CardAdv(data?.data.data)}</div>
      </div>
    </div>
  );
};
