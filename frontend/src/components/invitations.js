      ...
      render: (text, record) => (
        <Space size="middle">
          <a onClick={handleAccept}>
            <span className="action-clr">Accept</span>
          </a>
          <a>
            <span className="action-clr">Reject</span>
          </a>
        </Space>
      ),
    },
  ...
  return (
    <>
      <div>
        <div>
          <PageHeader
            subHeading="You can view all the invites of events here."
            heading="All Invitations"
          />
