        ...
        <div className="row top-marg ml-4">
          ...
          <div className="col-md-8 mt-4">
            ...
            <h6 className="mt-2 font-12">
              Phone: <span className="clr-blue">{data?.data.phone}</span>
            </h6>
            <h6 className="font-12">
              Address:<span className="clr-black">{data?.data.address}</span>
            </h6>
            <h6 className=" font-12">
              Email: <span className="clr-email">{data?.data.email}</span>
            </h6>
