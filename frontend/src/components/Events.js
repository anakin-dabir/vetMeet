...
const Events = () => {
  ...
  const { data: suggestedEvents, isLoading: isLoadingSuggested } = useSuggestedEventsQuery(
        ...
        return (
          <Space size="middle">
            <Link to="/dashboard/event">
              <span
                className="action-clr"
                onClick={() => {
                  localStorage.setItem("eventID", record.id);
  ...
  return (
    ...
    !isLoadingSuggested && (
      <>
        {/* -----------------------------My Created Events-------------------------------------- */}
        <PageHeader
          subHeading="You can add new Community Service Events."
          heading="Created Events"
          toLink="/dashboard/addnewevent"
        ...
        <div style={{ margin: "1rem 2rem" }}>
          <div>
            ...
            <div className="padding-Table">
              <TableComp
                data={veteran.data.createdEvents.map(e => {
                  return {
                    name: e.name,
                    time: e.eventTime,
        ...
        <div style={{ margin: "0rem 2rem" }}>
          <div>
            <div className="padding-Table">
              <TableComp
                data={veteran.data.interestedEvents.map(e => {
                  return {
                    name: e.name,
                    time: e.eventTime,
                    eventType: e.eventType,
        ...
        {/* -----------------------------My Created Events-------------------------------------- */}
        <PageHeader
          subHeading="You can view suggested events depending on your hobbies."
        ...
        <div style={{ margin: "0rem 2rem" }}>
          <div>
            <div className="padding-Table">
              <TableComp
                data={suggestedEvents.data.map(e => {
                  return {
                    name: e.name,
                    time: e.eventTime,
                    eventType: e.eventType,
