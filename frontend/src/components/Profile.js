    ...
    <>
      <div className="row top-marg ml-4">
        ...
        <div className="col-md-8 mt-4">
          <h2 className="name">
            {user.firstName + " " + user.lastName} <AddLocationAltIcon className="icon-clr" />
            <small className="city">Lahore</small>
          </h2>
          <small className="profession">{user.profession}</small>
          <h5 className="mt-4">{user.stars} ⭐</h5>
          <h5>
            <SupervisedUserCircleOutlinedIcon /> {user.followed.length} following
          </h5>
          <Divider plain>About</Divider>
          <small className="Contact-info">Contact Information</small>
          <h6 className="mt-2 font-12">
            Phone: <span className="clr-blue">{user.phone}</span>
          </h6>
          <h6 className="font-12">
            Address:<span className="clr-black">{user.address}</span>
          </h6>
          <h6 className=" font-12">
            Email: <span className="clr-email">{user.email}</span>
          </h6>
